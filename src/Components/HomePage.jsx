  ...
  const HomePage = () => {
    return (
      ...
      >
        ...
        <nav className=" w-full top-0 p-4 flex flex-col md:flex-row justify-center space-x-10 items-center z-10 max-w-[1200px]">
          ...
          <div className="relative w-full md:w-1/3 mb-4 md:mb-0">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-black rounded-full focus:outline-none "
            />
          </div>
        ...
        >
          {/* Overlay */}
          <div className="absolute inset-0 bg-gradient-to-b from-blue-900 via-transparent to-blue-900">
        ...
        <div className="relative flex flex-col items-center mt-10 md:mt-20 text-center px-4">
          ...
          <p className="mt-4 text-sm md:text-lg text-blue-900 font-extrabold">Discover Games You Love</p>
          <button className="mt-6 px-6 py-3 bg-blue-500 rounded-full text-sm md:text-lg hover:bg-blue-700 flex  items-center">Play Now <FaArrowRightLong /></button>
        </div>

        <div className="absolute bottom-10 text-center w-full flex justify-center z-10 ">
          <h2 className="text-xl md:text-2xl font-bold">Currently Trending Game</h2>
        </div>
      </div>
    );
  };
