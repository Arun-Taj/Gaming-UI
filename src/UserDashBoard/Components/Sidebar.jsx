...
const Sidebar = () => {
  return (
    <div className="bg-gray-800  p-4 text-white ">
      ...
      <ul>
        <li className="mb-4 flex items-center space-x-2"><RiHome2Line />
        <a href="#" className="hover:text-gray-400">Store</a>
        </li>
        <li className="mb-4 flex items-center space-x-2"><TbBrowser/>
        <a href="#" className="hover:text-gray-400">Browse</a> 
          </li>
        <li className="mb-4 flex items-center space-x-2"><MdLibraryAdd />
        <a href="#" className="hover:text-gray-400">Library</a>
        </li>
        <li className="mb-4 flex items-center space-x-2"><MdHistory />
        <a href="#" className="hover:text-gray-400">History</a>
        </li>
        <li className="mb-4 flex items-center space-x-2"><MdSendAndArchive />
      ...
      />
        ...
        className="w-8 h-8 rounded-full  border-gray-300"
      />
          <a href="#" className="hover:text-gray-400">Call of Duty</a></li>
        <li className="mb-2 flex items-center space-x-1">
        <img
        src="src/assetsUserDashBoard/Fc24.jpeg" 
        alt="Profile"
        className="w-8 h-8 rounded-full  border-gray-300"
      />
          <a href="#" className="hover:text-gray-400">Fortnite</a></li>
        <li className="mb-2 flex items-center space-x-1">
        <img
        src="src/assetsUserDashBoard/Fc24.jpeg" 
        alt="Profile"
        className="w-8 h-8 rounded-full  border-gray-300"
      />
          <a href="#" className="hover:text-gray-400">NBA 2K23</a></li>
        <li className="mb-2 flex items-center space-x-1">
        <img
        src="src/assetsUserDashBoard/Fc24.jpeg" 
        alt="Profile"
