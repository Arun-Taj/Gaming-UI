...
const Sidebar = () => {
  ...
  return (
    <>
    <div className="dark:bg-gray-800 bg-lightModeBg p-4 dark:text-white text-black w-full lg:w-64">
      <h2 className="text-2xl font-bold mb-6">Menu</h2>
      
      <ul>
        {links.map(({id,link,icon,Label})=>(<li key={id} className="mb-4 flex items-center space-x-2">
          {icon}
